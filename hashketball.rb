...
def game_hash 
  home = {
    ...
    players: [
      ...
      :Mason_Plumee => {number: "1", shoe: "19", points: "26", rebounds: "11", assists: "6", steals: "3", blocks: "8", slam_dunks: "5"},
  ...
  away = {
    team_name: "Charlotte Hornets", colors: ["Turquoise", "Purple"], players: [
      ...
      :Bismack_Biyombo => {number: "0", shoe: "16", points: "12", rebounds: "4", assists: "7", steals: "22", blocks: "15", slam_dunks: "10"},
     :Desagna_Diop => {number: "2", shoe: "14", points: "24", rebounds: "4", assists: "7", steals: "4", blocks: "5", slam_dunks: "5"},
     :Ben_Gordon => {number: "8", shoe: "15", points: "33", rebounds: "3", assists: "2", steals: "1", blocks: "1", slam_dunks: "0"},
     :Kemba_Walker => {number: "33", shoe: "15", points: "6", rebounds: "12", assists: "12", steals: "7", blocks: "5", slam_dunks: "12"}
