...
def num_points_scored(name)
  ...
  game_hash.each do |location, team_data|
    team_data[:players].each do |player, attribute_data|
      if player == name
        points = attribute_data[:points]
      end
    end
  end
...
def big_shoe_rebounds
  ...
  game_hash.each do |location, team_data|
    team_data[:players].each do |player, attribute_data|
      if shoe == nil || shoe < attribute_data[:shoe]
        shoe = attribute_data[:shoe]
        rebounds = attribute_data[:rebounds]
      end
    end
  end
