...
def team_colors(check_name)
game_hash.each do |location, team_data|
  if team_data[:team_name] == check_name
...
def big_shoe_rebounds
  ...
  game_hash.each do |location, team_data|
      team_data[:players].each do |player, info|
        if game_hash[location][:players][player][:shoe] > shoe_size
          big = game_hash[location][:players][player][:shoe]
