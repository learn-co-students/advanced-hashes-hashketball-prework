...
def game_hash => {
  :home => {
    ...
    :players => [
      ...
      {name: "Mason Plumee" , number: "1" , shoe: "19" , points: "26" , rebounds: "11", assists: "6" , steals: "3", blocks: "8", slam_dunks: "5"}
  ...
  :away => {
    ...
    :players => [
      {name: "Alan Anderson" , number: "0" , shoe: "16", points: "22" , rebounds: "12" , assists: "12" , steals: "3", blocks: "1", slam_dunks: "1" }
      {name: , number: , shoe: , points: , rebounds: , assists: , steals: , blocks:, slam_dunks:  }
      {name: , number: , shoe: , points: , rebounds: , assists: , steals: , blocks:, slam_dunks:  }
      {name: , number: , shoe: , points: , rebounds: , assists: , steals: , blocks:, slam_dunks:  }
      {name: , number: , shoe: , points: , rebounds: , assists: , steals: , blocks:, slam_dunks:  }
